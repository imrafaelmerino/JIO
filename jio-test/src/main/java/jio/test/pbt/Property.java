...
public non-sealed class Property<O> implements Testable {
     ...
     * @param gen  The data generator, represented by a Gen object, that produces pseudorandom data to feed the property
     *             tests.
     * @param fn   The property testing function, represented by a Function, that takes generated data of type O and
     ...
     * @param gen  The data generator, represented by a Gen object, that produces pseudorandom data to feed the property
     *             tests.
     * @param fn   The property testing function, represented by a BiFunction, that takes a JSON configuration (JsObj)
