...
public final class PropBuilder<O> implements Supplier<Property<O>>{
    ...
    private final BiLambda<JsObj, O, TestResult> property;
    ...
    private PropBuilder(String name, Gen<O> gen, BiLambda<JsObj, O, TestResult> property) {
        this.name = name;
        this.gen = gen;
     ...
     */
    public static <O> PropBuilder<O> ofLambda(final String name,
                                              final Gen<O> gen,
     ...
     */
    public static <O> PropBuilder<O> ofLambda(String name,
                                              Gen<O> gen,
     ...
     * {@link #of(String, Gen, BiFunction)} method instead.
     *
     * @param name     The name of the property, which provides a descriptive label for the property being tested.
     * @param gen      The data generator, represented by a Gen object, that produces pseudorandom data to feed the
     *                 property tests.
     ...
     * @param <O>      The type of the data generated by the Gen object and processed by the testing function.
     * @return A new Property instance representing the defined property.
     * @see #of(String, Gen, BiFunction)
     */
    public static <O> PropBuilder<O> of(final String name,
                                        final Gen<O> gen,
                                        final BiFunction<JsObj, O, TestResult> property
                                       ) {
        if (name == null || name.isBlank() || name.isEmpty())
            throw new IllegalArgumentException("property name missing");
        BiLambda<JsObj, O, TestResult> bfn = (conf, o) -> IO.succeed(property.apply(conf, o));
        return new PropBuilder<>(name,
                                 gen,
                                 bfn);
    }
     ...
     */
    public PropBuilder<O> withDescription(final String description) {
     ...
     */
    public PropBuilder<O> withTimes(int times) {
     ...
     */
    public PropBuilder<O> withReportPath(final Path path) {
     ...
     */
    public PropBuilder<O> withClassifiers(final Map<String, Predicate<O>> classifiers,
