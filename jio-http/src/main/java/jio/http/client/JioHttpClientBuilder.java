...
public final class JioHttpClientBuilder {
    ...
    /**
     * Disables the recording of Java Flight Recorder (JFR) events for HTTP requests performed by the client. By
     * default, JFR events are recorded (enabled). Use this method to disable recording if needed.
     *
