 ...
 *   <li>{@link jio.http.client.HttpExceptionFun}: A utility class containing predicates to identify specific exceptions that may occur when connecting to a server, such as timeouts, unresolved hosts, and more.</li>
 * </ul>
