 ...
 * <ul>
 * <li>{@link jio.console.Console}: The central class that creates a Read, Eval, Print Loop (REPL) program. It accepts a
 * list
 * of user-defined commands and provides methods to execute them interactively. Predefined commands are also
 * available.</li>
 *
 * <li>{@link jio.console.Command}: An interface that defines the structure of a console command. Developers can
 * implement this
 * interface to create custom commands for the console application.</li>
 *
 * <li>{@link jio.console.State}: A class that represents the state of the console application. It manages variables,
 * command history,
