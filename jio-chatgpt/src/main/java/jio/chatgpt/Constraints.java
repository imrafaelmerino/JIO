...
final class Constraints {
    ...
    static final int MIN_CHAT_COMPLETION_CHOICES = 1;
    static final int MAX_CHAT_COMPLETION_SIZE_STOP = 4;
    static final double MIN_CHAT_COMPLETION_PRESENCE_PENALTY = -2.0;
    static final double MAX_CHAT_COMPLETION_PRESENCE_PENALTY = 2.0;
    static final double MIN_CHAT_COMPLETION_FREQ_PENALTY = -2.0;
    static final double MAX_CHAT_COMPLETION_FREQ_PENALTY = 2.0;
    ...
    static final double MAX_COMPLETION_TOP_P = 1.0;
    static final double MIN_COMPLETION_TOP_P = 0.0;
