 ...
 * <p>
 * It's widely used by the {@link RetryPolicy} function to implement different policies.
...
public final class Delay extends IO<Void> {
    ...
    /**
     * a completable future completed with null after the specified delay
     * by a thread from the executor.
     * If the duration is zero, the future is completed with the caller
     * thread.
     *
