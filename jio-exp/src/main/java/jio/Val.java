 ...
 * {@code Val} (irreducible) or {@code Exp} (composable expressions made up of different operations). While {@code Val}
 * represents a final value, {@code Exp} expressions are composable and can involve multiple sub-effects that need to be
