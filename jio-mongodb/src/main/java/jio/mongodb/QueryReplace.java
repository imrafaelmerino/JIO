 ...
 *
 * <p>In MongoDB, a query document is used to specify which documents in a collection should be replaced, and a new document defines the structure and content of the replacement documents. The `QueryReplace` class encapsulates both the query and the new document for use in replace operations, providing a convenient way to express these two key aspects of MongoDB document replacement.</p>
 *
