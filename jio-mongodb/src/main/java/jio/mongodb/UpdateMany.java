 ...
 * <p>
 * The `UpdateMany` class is designed for performing updateCommands operations to modify multiple documents within a MongoDB
...
public final class UpdateMany extends Op implements MongoLambda<QueryUpdate, UpdateResult> {
    ...
    /**
     * Specifies an executor to be used for running the updateCommands many operation asynchronously.
     *
