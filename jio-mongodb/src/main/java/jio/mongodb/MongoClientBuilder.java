...
public final class MongoClientBuilder {
    ...
    private MongoClientBuilder(Function<String, ConnectionString> buildConnection, Function<ConnectionString, MongoClientSettings> buildSettings) {
    ...
    private MongoClientBuilder(Function<ConnectionString, MongoClientSettings> buildSettings) {
        this(ConnectionString::new, buildSettings);
    ...
    /**
     * Creates a new instance of {@code MongoClientBuilder} with a custom settings function. This factory method is
     * useful when you need more configuration than the default provided by the {@link #DEFAULT} builder.
     * <p>
